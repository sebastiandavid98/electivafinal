...
Write-Host "🚀 Creando Pull Requests para evaluaciones_heidy..." -ForegroundColor Green
Write-Host ""

# PR #1: Models
Write-Host "📝 Creando PR #1: Models..." -ForegroundColor Cyan
gh pr create `
  --repo $REPO `
  --base $DEV_BRANCH `
  --head "feature/models" `
...
Write-Host "✅ PR #1 creado" -ForegroundColor Green
Write-Host ""

# PR #2: Authentication
Write-Host "📝 Creando PR #2: Authentication..." -ForegroundColor Cyan
gh pr create `
  --repo $REPO `
  --base $DEV_BRANCH `
...
Write-Host "✅ PR #2 creado" -ForegroundColor Green
Write-Host ""

# PR #3: Forms
Write-Host "📝 Creando PR #3: Forms..." -ForegroundColor Cyan
gh pr create `
  --repo $REPO `
  --base $DEV_BRANCH `
  --head "feature/forms" `
...
Write-Host "✅ PR #3 creado" -ForegroundColor Green
Write-Host ""

# PR #4: Views
Write-Host "📝 Creando PR #4: Views..." -ForegroundColor Cyan
gh pr create `
  --repo $REPO `
  --base $DEV_BRANCH `
  --head "feature/views" `
...
Write-Host "✅ PR #4 creado" -ForegroundColor Green
Write-Host ""

# PR #5: Templates
Write-Host "📝 Creando PR #5: Templates..." -ForegroundColor Cyan
gh pr create `
  --repo $REPO `
  --base $DEV_BRANCH `
...
Write-Host "✅ PR #5 creado" -ForegroundColor Green
Write-Host ""

# PR #6: Configuration (dev → master)
Write-Host "📝 Creando PR #6: Configuration (dev → master)..." -ForegroundColor Cyan
gh pr create `
  --repo $REPO `
  --base $MASTER_BRANCH `
  --head $DEV_BRANCH `
...
Write-Host "✅ PR #6 creado" -ForegroundColor Green
Write-Host ""

Write-Host "🎉 ¡Todos los PRs han sido creados exitosamente!" -ForegroundColor Green
Write-Host ""
Write-Host "Próximos pasos:" -ForegroundColor Yellow
Write-Host "1. Revisa los PRs en: https://github.com/sebastiandavid98/ElectivaFinal/pulls"
Write-Host "2. Aprueba y mergea los PRs de features a dev"
Write-Host "3. Aprueba y mergea dev a master"
